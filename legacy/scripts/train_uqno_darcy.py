...
from legacy.neuralop import H1Loss, LpLoss, Trainer, get_model
from legacy.neuralop.data.datasets.darcy import DarcyDataset
from legacy.neuralop.data.datasets.tensor_dataset import TensorDataset
from legacy.neuralop.data.transforms.data_processors import DataProcessor, DefaultDataProcessor
from legacy.neuralop.data.transforms.normalizers import UnitGaussianNormalizer
from legacy.neuralop.losses.data_losses import PointwiseQuantileLoss
from legacy.neuralop.models import UQNO
from legacy.neuralop.training import setup
...
sys.path.insert(0, "../")
from legacy.config.uqno_config import Default
