...
from legacy.neuralop import H1Loss, LpLoss, BurgersEqnLoss, ICLoss, WeightedSumLoss, Trainer, get_model
from legacy.neuralop.data.datasets import load_mini_burgers_1dtime
...
from legacy.neuralop.utils import get_wandb_api_key, count_model_params, get_project_root
...
sys.path.insert(0, "../")
from legacy.config.burgers_config import Default
