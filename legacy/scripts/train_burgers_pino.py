...
from legacy.neuralop import H1Loss, LpLoss, BurgersEqnLoss, ICLoss, get_model
...
from legacy.neuralop.losses.meta_losses import Relobralo, SoftAdapt
...
sys.path.insert(0, "../")
from legacy.config.burgers_pino_config import Default
