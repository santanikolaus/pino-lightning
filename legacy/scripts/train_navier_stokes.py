...
from legacy.neuralop.data.datasets.navier_stokes import load_navier_stokes_pt
from legacy.neuralop.data.transforms.data_processors import MGPatchingDataProcessor
from legacy.neuralop.utils import get_wandb_api_key, count_model_params
from legacy.neuralop.mpu.comm import get_local_rank
from legacy.neuralop.training import setup, AdamW
...
sys.path.insert(0, "../")
from legacy.config.navier_stokes_config import Default
