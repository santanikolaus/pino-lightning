...
from legacy.neuralop.layers.spectral_projection import spectral_projection_divergence_free
from legacy.neuralop.losses.differentiation import FourierDiff, FiniteDiff
