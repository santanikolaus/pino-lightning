...
from legacy.neuralop.layers.embeddings import regular_grid_2d
...
from legacy.neuralop.layers.embeddings import GridEmbedding2D
...
from legacy.neuralop.layers.embeddings import GridEmbeddingND
