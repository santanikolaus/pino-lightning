...
def unet_cfg(mixer, modes, hidden, levels):
...
def main():
    ...
    p.add_argument("--levels", default="", help="comma-separated extra spectral levels, e.g. 1")
    ...
    model = load_model(unet_cfg(args.mixer, args.modes, args.hidden, levels), args.ckpt, device)
