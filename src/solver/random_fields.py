...
# Note: the original paper-pino/solver/random_fields.py had a module-level
# torch.manual_seed(0) call here. It was removed because module-level RNG
# side effects corrupt the global seed state at import time, making tests
# and training runs non-reproducible.  Seed control belongs at the call site.
